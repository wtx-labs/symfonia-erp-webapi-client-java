...
public class SaleDocumentPosition {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ProductId", "ProductCode", "Description", "Quantity", "PriceValuePLN", "PriceValue", "NetValuePLN", "NetValue", "VatValuePLN", "GrossValue"));
